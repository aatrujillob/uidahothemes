---
title: "Writing"
author: "Andres Trujillo-Barrera"
date: ' '
output:
  pdf_document:
...
if (!require(idahothemes)) {
  library(devtools)
  devtools::install_github("aatrujillob/idahothemes")
}
 library(idahothemes) # Maybe could be useful if I add some features to the package
...
Currently using Zotero and the package citr for reference management.
The package papaja also seems useful to check for updates and ideas. package rticles has been deprecated and authors moved to bookdown. Still, pandoc-crosref seems a bit better handling numbering of tables and equations, or at least easier to setup.

<!--
If want to put sections in other documents:
